...
using TiendaOnline.Data.ClasesRepositorios;
...
namespace TiendaOnline
{
    public class Startup
    {
        ...
        {
            services.AddScoped<IContenedor, Contenedor>();//Aqui es para agregar nuestras dependencias
            ...
            //EmailSender para que pueda funcionar el login

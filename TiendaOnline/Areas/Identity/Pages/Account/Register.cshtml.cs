    ...
    public class RegisterModel : PageModel
    {
        ...
        public async Task<IActionResult> OnPostAsync(string returnUrl = null)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    if(!await _role.RoleExistsAsync(@CNT.Admin)) 
                    {
                        await _role.CreateAsync(new IdentityRole(@CNT.Admin));
                        await _role.CreateAsync(new IdentityRole( @CNT.Usuario));

                    }

                    string role = Request.Form["rad"];
                    if (role == CNT.Admin)
                    {
